...
public class DialogUtil {
     ...
     *可编辑对话框
     */
    public static void showAlertDialogEdit(Context context, String title, final EditFinishListener listenerSure,
                                           final DialogInterface.OnClickListener listenerCancel) {
        LayoutInflater factory = LayoutInflater.from(context);//提示框
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                listenerSure.onSure(edit.getText().toString());
            }
        });
        builder.setNegativeButton("取消", listenerCancel);
        builder.create().show();
